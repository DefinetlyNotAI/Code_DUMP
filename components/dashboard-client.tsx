...
export function DashboardClient() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <DashboardHeader accounts={accounts} selectedAccount={selectedAccount} onAccountChange={setSelectedAccount} />
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        ...
        <div className="flex-1 overflow-y-auto bg-background">
          {selectedEmail ? (
            <EmailViewer accountId={selectedAccount!} folder={selectedEmail.folder} uid={selectedEmail.uid} />
          ) : (
