...
> [!IMPORTANT]
> Even though the original code had an main admin panel (this still has the subpanels, this doesn't (due to integration reasons) - So you should implement your own!
